...
- **VM image or SKU unavailable:** verify the approved Windows 11 publisher/offer/SKU in the target region. Pilot `Standard_B2s`; use `Standard_B2ms` only as the documented capacity fallback, preserving the package image contract and tags.
