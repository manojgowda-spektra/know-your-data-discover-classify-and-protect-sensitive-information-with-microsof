...
• Validations: 4
• Deployed services: Windows 11 Virtual Machine (Standard_B2s representative-pilot baseline; Standard_B2ms fallback), Network Interface, Virtual Network, Network Security Group, Public IP, StandardSSD_LRS Managed OS Disk, Boot Diagnostics, Custom Script Extension, Existing VM Auto-shutdown Schedule
